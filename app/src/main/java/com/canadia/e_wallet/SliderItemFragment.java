...
public class SliderItemFragment extends Fragment {
  ...
  private static final int[] PAGE_TITLES =
      new int[] {R.string.definitely_safe,R.string.best_service,R.string.easy_deposit,R.string.dream_deals };

  // prepare all subtitle ids arrays
  @StringRes
  private static final int[] PAGE_TEXT =
      new int[] {
         R.string.definitely_safe_text,R.string.best_service_text,R.string.easy_deposit_text,R.string.dream_deals_text
      };
  // prepare all subtitle images arrays
  @StringRes
  private static final int[] PAGE_IMAGE =
      new int[] {
          R.drawable.talk,R.drawable.security,R.drawable.talk,R.drawable.security
      };
